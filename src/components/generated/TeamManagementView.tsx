...
export function TeamManagementView({ onBack, onEmployeeClick }: TeamManagementViewProps) {
  const { token } = useAuth();
  ...
  const loadProfilerData = async () => {
    try {
      setLoading(true);
      console.log('👥 Lade Team-Daten aus Firebase...');
      ...
      console.log(`✅ ${data.length} Team-Datensätze aus ${snapshot.size} Firebase-Dokumenten geladen`);
  ...
  const handleEmployeeClick = (employee: ProfilerData) => {
    if (onEmployeeClick) {
      // Navigiere zur EmployeeDetailView
      console.log('👥 Navigiere zu EmployeeDetailView für:', employee.name);
      onEmployeeClick(employee.employeeId || employee.id);
    } else {
      // Fallback: Öffne Detail-Modal (für Admin-Ansicht)
      console.log('🔍 Öffne Detail-Modal für:', employee.name);
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900">Team-Verwaltung</h1>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <div className="flex flex-wrap gap-6 text-sm text-gray-600">
              <span>Gesamt: <strong>{profilerData.length}</strong> Mitarbeiter</span>
              <span>Gefiltert: <strong>{filteredAndSortedData.length}</strong> Mitarbeiter</span>
        ...
        {filteredAndSortedData.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Keine Team-Mitglieder gefunden</h3>
            <p className="text-gray-600">
              {profilerData.length === 0 
                ? 'Es wurden noch keine Team-Daten importiert.'
...
// Separate Komponente für Team Member Card
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="space-y-4">
            ...
            {/* User Object - nur für Führungskräfte vereinfacht */}
            {employee.user && renderSection('Mitarbeiter-Informationen', User, 'userData', employee.user)}
          </div>
        </div>
        </motion.div>
      </motion.div>
