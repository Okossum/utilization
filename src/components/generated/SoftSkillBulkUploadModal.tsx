...
interface SoftSkillBulkUploadModalProps {
  isOpen: boolean;
  onClose: () => void;
  onImportComplete: () => void;
}

const SoftSkillBulkUploadModal: React.FC<SoftSkillBulkUploadModalProps> = ({
  isOpen,
  onClose,
  onImportComplete,
}) => {
  ...
  const executeImport = async () => {
    ...
    try {
      const response = await fetch('/api/soft-skills/bulk-import', {
        method: 'POST',
        headers: {
            ...
            <header className="flex items-center justify-between p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Excel-Import für Soft Skills und Kategorien
                </p>
              </div>
              <button
                onClick={handleClose}
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                      Laden Sie eine Excel-Datei mit Soft Skills und Kategorien hoch
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>• <strong>Spalte A:</strong> Kategorie (z.B. "Persönlichkeit")</li>
                      <li>• <strong>Spalte B:</strong> Skill-Name (z.B. "Kommunikationsfähigkeit")</li>
...
export { SoftSkillBulkUploadModal };
